...
{
    public partial class SoftwareInstallation : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            Outlook.MailItem mail = application.CreateItemFromTemplate(AppDomain.CurrentDomain.BaseDirectory + @"\EmailTemplates\Access\AU-SDXXXX - Software Installation Request.oft") as Outlook.MailItem;
            mail.HTMLBody = mail.HTMLBody.Replace("AU-SDXXXX", "" + txtTicketNumber.Text + "");
            mail.HTMLBody = mail.HTMLBody.Replace("SoftwareName", ""+cmbSoftwareName.Text+"");
            ...
            mail.Subject = txtTicketNumber.Text.ToString() + "- Software Installation Request";
